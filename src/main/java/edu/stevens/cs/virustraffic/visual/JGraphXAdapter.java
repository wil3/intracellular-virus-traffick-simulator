...
public class JGraphXAdapter<V, E extends DefaultEdge> extends mxGraph implements GraphListener<V, E>
{
    ...
    public void addJGraphTEdge(E edge)
    {
        ...
        try
        {
            ...
            cell.setSource( vertexToCellMap.get(source));
            cell.setTarget(vertexToCellMap.get(target));
